                                            ...
                                            <div class="booktxt">
                                                ...
                                                <span class="bname">
                                                    <asp:Label runat="server" ID="order">
                                                        <Localized:LocalizedLiteral ID="LocalizedLiteral2" runat="server" Key="orderid" Colon="false" /></asp:Label>: <asp:Label ID="lblOrderNo" runat="server" Text='<%#Eval("OrderNo")%>'></asp:Label></span><span class="bname"><Localized:LocalizedLiteral ID="LocalizedLiteral7" runat="server" Key="lbl_book" Colon="false" />
                                                ...
                                                <span class="bname" runat="server" visible='<%# Eval("IspaperBook") %>'>Quantity : <asp:TextBox ID="txtQuanitity" runat="server" Text='<%# getQuantity(Eval("BookID").ToString(),Eval("Qauntity").ToString()) %>' onkeypress="return isNumberKey(event)" min='<%# getMinQuantity(Eval("BookID").ToString()) %>' max='<%# getMaxQuantity(Eval("BookID").ToString()) %>' ToolTip='<%# getMaxQuantity(Eval("BookID").ToString()) %>' type="number" Visible='<%# Eval("IspaperBook") %>'
                                                ...
                                                <span class="bname" runat="server" visible='<%# Eval("IspaperBook") %>'>
                                                    <Localized:LocalizedLabel ID="llblStock" runat="server" CssClass="bname" Key="BookNotInStock" Colon="false" ForeColor="Red" Visible='<%# getQuantity(Eval("BookID").ToString(),Eval("Qauntity").ToString()) >= 1?false:true %>'></Localized:LocalizedLabel></span><div class="rate">
                                                        ...
                                                        <span class="ratetxt" style="margin-top: 9px; margin-left: 5px;">(<%#Convert.ToString(Eval("TotalReview"))%><asp:Label ID="tr" runat="server">
                                                            <Localized:LocalizedLiteral ID="LocalizedLiteral6" runat="server" Key="rating" Colon="false" /></asp:Label>) </span></div><div class="movetxt">
                                                    ...
                                                    </asp:LinkButton></div></div><input type="hidden" value="0" id="hdnDeleteValue" /></div><div class="delbtn2">
                                            <asp:LinkButton ID="LinkButton1" type="button" OnClientClick='<%# getRemoveString() %>' CommandName="delete" CommandArgument='<%#Eval("BookID")+"@"+Eval("IseBook")+"@"+Eval("IsPaperbook")%>' runat="server" Text="Delete"><img src="images/delete.png" alt="" /></asp:LinkButton></div><div class="ptxt">
    ...
    <div class="wrap">
        ...
        <div class="loginbox1" style="margin-top: 0px; margin-bottom: 20px;">
                    ...
                    <ContentTemplate>
                        <div style="display: none">
                            ...
                            <asp:RadioButtonList Width="100%" CssClass="" ID="rblTest" AutoPostBack="true" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblTest_SelectedIndexChanged" runat="server">
                                <asp:ListItem Text="Economic" class="div form body" Value="1" Selected="True"></asp:ListItem><asp:ListItem Text="International" class="div form body" Value="2"></asp:ListItem><asp:ListItem Text="International EMS-Currier" class="div form body" Value="3"></asp:ListItem><asp:ListItem Text="Special" Value="4" class="div form body"></asp:ListItem></asp:RadioButtonList></div></ContentTemplate></asp:UpdatePanel><%-- <div class="div form body">                
                </div>--%></div><div class="logintxt" style="margin-top: 30px; display: none" id="Delivery" runat="server">
                <h1>
            ...
            <div class="check-box" style="margin-top: 5px; display: none" id="Addredd" runat="server">
                <div>
                    <a id="aClick" class="movebtn" onclick="toggle_visibility('dialog');" style="cursor: pointer; margin: 0;">Add <Localized:LocalizedLiteral ID="LocalizedLiteral6" runat="server" Key="deliveryAdd" Colon="false" />
                    </a>
                </div>

                <asp:Label ID="lblDefaultMessage" runat="server" Text="No data found" Style="font-family: abeezeeregular; color: Gray;" Visible="false">
               
                </asp:Label></div><div class="check-box" runat="server" id="chkout">
                                ...
                                <div class="first1">
                                    <div class="booktxt" style="width: auto;">
                                        ...
                                        <asp:Label ID="locallizationstate" runat="server" Visible="false" class="name1" Style="width: 100%">
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral28" runat="server" Key="state" Colon="false" /></asp:Label><asp:TextBox ID="txtState" runat="server" Text='<%#Eval("State")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox><asp:Label ID="locallizationcity" runat="server" Visible="false" class="name1" Style="width: 100%">
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral8" runat="server" Key="city" Colon="false" /></asp:Label><asp:DropDownList ID="txtCity" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="txtCity_SelectedIndexChanged" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>
                                        <asp:TextBox ID="txtcity12" runat="server" Text='<%#Eval("City")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox><div style="float: right; display: none">
                                            <asp:LinkButton ID="lnk_vis" runat="server" Text="Other" OnClick="lnk_vis_Click" Visible="false"></asp:LinkButton></div><asp:Label runat="server" ID="lblCityCode" class="aname"><%# Eval("City").ToString().Replace("- 00000","") + (Convert.ToString(Eval("Pincode")) != "00000" ? (" - " + Eval("Pincode")) : "") %></asp:Label><asp:Label ID="locallizationpincode" runat="server" Visible="false" class="name1" Style="width: 100%">
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral11" runat="server" Key="pincode" Colon="false" /></asp:Label><asp:TextBox ID="txtPincode" runat="server" Text='<%#Eval("Pincode")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;" onkeypress="return isNumberKey(event)"></asp:TextBox><span class="aname"></span><span class="bname"><asp:Label runat="server" ID="lblPhoneNumber" Text='<%#Convert.ToString(Eval("PhoneNumber"))%>'></asp:Label><asp:Label ID="locallizationPhone" runat="server" Visible="false" class="name1" Style="width: 100%">
                                                <Localized:LocalizedLiteral ID="LocalizedLiteral12" runat="server" Key="Phone" Colon="false" /></asp:Label><asp:TextBox runat="server" ID="txtPhoneNumber" Text='<%#Convert.ToString(Eval("PhoneNumber"))%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox></span><span class="bname" style="display: none;"><asp:Label runat="server" ID="lblShipping" CssClass="shippingLabel"></asp:Label></span></div><input type="hidden" value="0" id="hdnDeleteValue" /></div><div class="delbtn2">
                                    ...
                                    </asp:LinkButton></div><div class="ptxt">
                    ...
                    <div class="asd-order-box">
                        ...
                        <div class="asd-order-tbl">
                            <table width="100%">
                                ...
                                <tr>
                                    <td>
                                        <asp:Literal ID="lblProduct" runat="server"></asp:Literal></td><td>
                                        <asp:Literal ID="lblProductTotal" runat="server"></asp:Literal></td></tr><tr>
                                    <td>
                                        <b>
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral26" runat="server" Key="subtotal" Colon="false" /></b>
                                    </td>
                                    <td>
                                        <b>
                                            <asp:Literal ID="lblSubtotalAmount" runat="server"></asp:Literal></b></td></tr><tr id="Shipping" runat="server">
                                    <td>
                                        <b>
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral24" runat="server" Key="shipping" Colon="false" /></b>
                                    </td>
                                    <td>
                                        <div>
                                            <asp:RadioButton ID="chkdhl" runat="server" GroupName="Shiping" onchange="val(this);" Style="padding: 0px" />
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral18" runat="server" Key="DHL_shipping_Amount" Colon="false" />&nbsp; <b><asp:Label ID="lbldhl1" runat="server"></asp:Label></b><br /><asp:RadioButton ID="chknational" runat="server" onchange="val(this);" GroupName="Shiping" />
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral17" runat="server" Key="national_shipping_amount" Colon="false" />&nbsp; <b><asp:Label ID="lblShipAmount" runat="server" CssClass="Shipping"></asp:Label></b><asp:Label ID="lblShipAmount1" runat="server" Style="display: none"></asp:Label><asp:Label ID="lbldhl" Text="0" runat="server" Style="display: none"></asp:Label></div></td></tr><tr>
                                    <td>
                                        <b>
            ...
            <div>
                ...
                </asp:LinkButton></div><div id="dialog" class="wrap" style="display: none;" align="center">
                <div class="loginbox1">
                    ...
                    <div class="frm-txt">
                        <label class="name1">
                            ...
                            <span class="star">*</span></label> <asp:TextBox ID="txtname" runat="server" class="nametxt" Text=""></asp:TextBox></div><div class="frm-txt">
                        <label class="name1" style="width: 100%;">
                            <Localized:LocalizedLiteral ID="LocalizedLiteral2" runat="server" Key="shipAdd1" Colon="false" />
                            (<Localized:LocalizedLiteral ID="LocalizedLiteral20" runat="server" Key="shipAdd1_Detail" Colon="false" />) <span class="star">*</span></label> <asp:TextBox ID="txtaddress" runat="server" class="nametxt" TextMode="MultiLine" Text=""></asp:TextBox></div><div class="frm-txt">
                        <label class="name1" style="width: 100%;">
                            <Localized:LocalizedLiteral ID="LocalizedLiteral7" runat="server" Key="shipAdd2" Colon="false" />
                            (<Localized:LocalizedLiteral ID="LocalizedLiteral21" runat="server" Key="shipAdd2_Detail" Colon="false" />) </label><asp:TextBox ID="txtlandmark" runat="server" class="nametxt" Text=""></asp:TextBox></div><div class="frm-txt">
                        <label class="name1" style="width: 100%;">
                            <Localized:LocalizedLiteral ID="LocalizedLiteral16" runat="server" Key="Region" Colon="false" />
                            <span class="star">*</span></label> <asp:DropDownList ID="ddlregion" OnSelectedIndexChanged="ddlregion_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="nametxt" AppendDataBoundItems="true"></asp:DropDownList>
                    ...
                    <div class="frm-txt">
                        <label class="name1">
                            ...
                            <span class="star">*</span></label> <asp:DropDownList ID="ddlCountry" AutoPostBack="true" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" runat="server" CssClass="nametxt" AppendDataBoundItems="true"></asp:DropDownList>
                        <%--<asp:TextBox ID="txtcountry" runat="server" class="nametxt" Text="" onkeypress="return onlyAlphabets(event,this);"></asp:TextBox>--%>
                    </div>
                    ...
                    <div class="frm-txt">
                        ...
                        <asp:TextBox ID="txtstate" runat="server" class="nametxt" Text=""></asp:TextBox></div><div class="frm-txt">
                        <label class="name1">
                            <Localized:LocalizedLiteral ID="LocalizedLiteral8" runat="server" Key="city" Colon="false" />
                            <span class="star">*</span></label> <asp:DropDownList ID="ddlcityi" CssClass="nametxt" runat="server" Visible="true" AutoPostBack="true" OnSelectedIndexChanged="ddlcityi_SelectedIndexChanged"></asp:DropDownList>
                        <asp:TextBox ID="txtcity" runat="server" Visible="false" class="nametxt" Text=""></asp:TextBox><div style="float: right; display: none">
                            <asp:LinkButton ID="lnkother" runat="server" Text="Other" OnClick="lnkother_Click"></asp:LinkButton></div></div><div class="frm-txt">
                        <label class="name1">
                            <Localized:LocalizedLiteral ID="llPincode" runat="server" Key="pincode" Colon="false" />
                        </label>
                        <asp:TextBox ID="txtpincode" runat="server" class="nametxt" Text="" onkeypress="return isNumberKey(event)"></asp:TextBox></div><div class="frm-txt">
                        <label class="name1">
                            <Localized:LocalizedLiteral ID="LocalizedLiteral12" runat="server" Key="Phone" Colon="false" />
                            <span class="star">*</span></label> <asp:TextBox ID="txtPhone" runat="server" class="nametxt" Text=""></asp:TextBox></div><div class="frm-txt" style="margin-bottom: 17px;">
                        <label class="name1" style="width: 100%;">
                    ...
                    <div class="btns">
                        <a onclick="toggle_visibility('dialog');" style="cursor: pointer;" class="back">
                            <img src="images/backarw.png" alt="" class="bkarw" /> <Localized:LocalizedLiteral ID="lblback" runat="server" Key="hide" Colon="false" /></a>
                        ...
                        </asp:LinkButton></div></div></div></div></div></asp:Content>