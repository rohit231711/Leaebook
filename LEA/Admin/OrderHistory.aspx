<%@ Page Title="Order History" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="OrderHistory.aspx.cs" Inherits="Admin_OrderHistory" %>
            ...
            <asp:GridView ID="gvBookStatus" runat="server" SkinID="skinGrid" GridLines="None" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        ...
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                            <%--<asp:Label ID="lblOrderStatus" runat="server" Text='<%# Eval("OrderStatus") %>' Visible='<%# Convert.ToBoolean(Eval("IsPaperBook")) ? false : true %>'></asp:Label>--%>
                            <asp:Label ID="lblOrderStatus" runat="server" Text='<%# Eval("OrderStatus") %>'></asp:Label>
                            <asp:LinkButton ID="lnkPdf" runat="server" Text='<%# Eval("AppCode") %>' CommandArgument='<%# Eval("AppCode") %>' OnClick="lnkDownload_Click" Visible='<%# !Convert.ToBoolean(Eval("IsPaperBook")) ? false : true %>'></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        function ViewOrder(ID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#span_shipingcharge').html('$' + parseFloat(data.d[0].ShippingCharge).toFixed(2));
