<%@ Page Title="Economic Services" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="EconomicService.aspx.cs" Inherits="Admin_EconomicService" %>
            ...
            <tbody>
                ...
                <tr class="light_bg">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                        <asp:TextBox ID="txtfrwe" class="input_box user1"  onkeypress="return isNumberKey(event,this)" runat="server"></asp:TextBox>
