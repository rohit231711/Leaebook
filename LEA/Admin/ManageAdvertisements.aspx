<%@ Page Title="Manage Advertisement" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ManageAdvertisements.aspx.cs" Inherits="Admin_ManageAdvertisements" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function backcode() {
            debugger;
            if (document.getElementById('<%=txtcategory.ClientID %>').value == "" && document.getElementById('<%=txtcategory1.ClientID %>').value == "") {
                alert("Please insert advertisement Title.");
                return false;
            }
            else {
                document.getElementById('<%=hndAdv.ClientID %>').value = document.getElementById('<%=txtcategory.ClientID %>').value;
                document.getElementById('<%=hndAdv1.ClientID %>').value = document.getElementById('<%=txtcategory1.ClientID %>').value;
    ...
    <asp:HiddenField ID="hndAdv" runat="server" />
    <asp:HiddenField ID="hndAdv1" runat="server" />
    <div id="product-table">
                                ...
                                <div id="actions-box-slider" style="display: none;">
                                    <a id="callConfirm" onclick="conf(); return false;" class="action-delete" style="cursor: pointer">
                                        Delete</a> <%--<a id="testCheck2" onclick="statusactive()" class="action-delete" style="cursor: pointer">
                                            Active</a> <asp:LinkButton id="testCheck3" onclick="lkbDelete_Click()" CommandArgument='<%#Eval("AdvertisementID")%>' class="action-delete" runat="server" style="cursor: pointer">
                                                Inactive</asp:LinkButton>
                                </div>--%>
                                <div class="clear">
                                </div>
                            </div>
                        ...
                        <td width="16%" valign="bottom" align="right">
                            <div style="padding-bottom: 1px; padding-right: 5px; text-align: right; float: right;">
                                <asp:Button ID="lkbAdd" Style="padding-left: 10px;" Text="Add New" CssClass="button_bg"
                                    runat="server" PostBackUrl="~/Admin/AddAdvertisements.aspx" />
        ...
        <div id="form_user_managementview">
            <asp:GridView ID="gvCategory" runat="server" SkinID="skinGrid" GridLines="None" AutoGenerateColumns="false"
                ...
                OnRowDataBound="gvCategory_RowDataBound" OnSorting="gvCategory_Sorting" EmptyDataRowStyle-HorizontalAlign="Center"
                ...
                <Columns>
                    <asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hfCategoryID" runat="server" Value='<%#Eval("AdvertisementID")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbCategory" runat="server" CommandArgument="AdvertisementID" CommandName="Sort"
                                Text="Advertisement Title (English)" CssClass="no-sort"></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbCategory1" runat="server" CommandArgument="AdvertisementID" CommandName="Sort"
                                Text="Advertisement Title (Spanish)" CssClass="no-sort"></asp:LinkButton>
                            <asp:Image ID="imgCategory1" Visible="false" runat="server" AlternateText=" " />
                        </HeaderTemplate>
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                            <asp:Label ID="lblCategoryName1" runat="server" Text='<%# Eval("Title1") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkblinkurl" runat="server" CommandArgument="LinkURL" CommandName="Sort"
                                Text="Advertisement link" CssClass="no-sort"></asp:LinkButton>                            
                        </HeaderTemplate>
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderStyle-Width="70px" ItemStyle-Width="70px">
                        ...
                        <ItemTemplate>
                            <asp:LinkButton ID="lkbEdit" runat="server" CssClass="icon-101" CommandName="Edit1"
                                CommandArgument='<%#Eval("AdvertisementID")%>'></asp:LinkButton>
                            <asp:HiddenField ID="hfID" runat="server" Value='<%#Eval("AdvertisementID")%>' />
                            <asp:LinkButton ID="lkbDelete" runat="server" CssClass="icon-102" CommandName="Delete1"
                                CommandArgument='<%#Eval("AdvertisementID")%>' OnClientClick="return confirm('Are you sure you want to delete?');"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="light_bg">
                                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                                                    <strong>Advertisement Title (English)</strong>
                                                </td>
                                                ...
                                                <td class="popup_listing_border" align="left" valign="middle" width="459">
                                                    <input class="input_box" name="txt_srcref_id" id="txtcategory" type="text" runat="server" />
                                                </td>
                                            </tr>
                                            <tr class="light_bg">
                                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                                                    <strong>Advertisement Title (Spanish)</strong>
                                                </td>
                                                <td class="popup_listing_border" align="left" height="37" width="11">
                                                    &nbsp;
                                                </td>
                                                <td class="popup_listing_border" align="left" valign="middle" width="459">
                                                    <input class="input_box" name="txt_srcref_id" id="txtcategory1" type="text" runat="server" />
                                                </td>
                                            </tr>
                                            <tr class="white_bg">
                                                <td align="right">
