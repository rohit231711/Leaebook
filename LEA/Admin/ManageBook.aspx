<%@ Page Title="Manage eBooks" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ManageBook.aspx.cs" Inherits="Admin_ManageBook" %>
            ...
            <asp:GridView ID="gvBook" runat="server" SkinID="skinGrid" GridLines="None" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        ...
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbBook" CssClass="no-sort" runat="server" Text="eBook/Paper Book Title" CommandName="sort" CommandArgument="Title"></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbLanguage" runat="server" Text="Language" CssClass="no-sort" CommandName="sort" CommandArgument="Language"></asp:LinkButton>
                        </HeaderTemplate>
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
