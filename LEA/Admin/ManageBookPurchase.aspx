<%@ Page Title="Book Purchase Report" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="ManageBookPurchase.aspx.cs" Inherits="Admin_ManageBookPurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="product-table">
        ...
        <div id="form_user_managementview">
            <asp:GridView ID="gvRegistration" runat="server" SkinID="skinGrid" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black" HeaderText="Book Type">
                        <HeaderStyle CssClass="table-header-repeat line-left" Font-Size="13px" Font-Bold="true" Font-Names="Tahoma" />
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                            <asp:Label ID="lblePaperType" runat="server" Text='<%# Convert.ToBoolean(Eval("IseBook").ToString()) == true ? "eBook" : "" %>'></asp:Label>
                            <asp:Label ID="Label1" runat="server" Text='<%# Convert.ToBoolean(Eval("IsPaperBook").ToString()) == true ? "Paper Book" : "" %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        ...
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                            <asp:Label ID="lblAmount" runat="server" Text='<%# Convert.ToDecimal(Eval("Amount").ToString()) == 0 ? "FREE" : Eval("Amount") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
        ...
        <div class="pmt_receivebox" style="text-align: center; border: #d6d6d6 1px solid; background-color: #f1f1f1; width: 378px; margin-left: 325px; height: 38px; margin-top: 15px; vertical-align: -webkit-baseline-middle; padding-top: 20px;">
