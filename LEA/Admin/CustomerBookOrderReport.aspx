<%@ Page Title="Order Report" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true"
    CodeFile="CustomerBookOrderReport.aspx.cs" Inherits="Admin_CustomerBookOrderReport" %>
                        ...
                        <asp:GridView ID="grdSubscriptions" OnPageIndexChanging="grdSubscriptions_OnPageIndexChanging"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-ForeColor="Black">
                                    <HeaderStyle CssClass="table-header-repeat line-left" />
                                    <HeaderTemplate>
                                        <asp:LinkButton ID="lkbAutoher" runat="server" CssClass="no-sort" Text="Author"></asp:LinkButton>
                                    </HeaderTemplate>
                                    <ItemStyle Font-Size="14px" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAutoher" runat="server" Text='<%# Eval("Autoher") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-ForeColor="Black">
                                    <HeaderStyle CssClass="table-header-repeat line-left" />
                                    <HeaderTemplate>
                                        <asp:LinkButton ID="lkbOrderDate" runat="server" CssClass="no-sort" Text="Purchase Date"></asp:LinkButton>
                                    </HeaderTemplate>
                                    <ItemStyle Font-Size="14px" />
                                    <ItemTemplate>
                                        <asp:Label ID="lblAutoher" runat="server" Text='<%# Eval("orderdate") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <%--<asp:TemplateField ItemStyle-ForeColor="Black">
                                    <HeaderStyle CssClass="table-header-repeat line-left" />
