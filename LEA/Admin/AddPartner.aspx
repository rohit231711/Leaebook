<%@ Page Title="Add User" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="AddPartner.aspx.cs" Inherits="Admin_AddPartner" %>
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById('<%=txtPassword.ClientID %>').value.length < 6) {
                $("#message-green").show().fadeOut(5000);
                document.getElementById('succ').innerHTML = "minimum six character is required in password.";
                return false;
            }
            ...
            <table align="center" id="id-form" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tbody>
                    ...
                    <tr class="light_bg">
                        ...
                        <td class="popup_listing_border" align="left" valign="middle" width="459">
                            <asp:TextBox CssClass="input_box" ID="txtName" runat="server"></asp:TextBox>
                            <font class="required">*</font>
                        </td>
                    </tr>
                    <tr class="light_bg">
                    ...
                    <tr class="white_bg">
                        ...
                        <td align="left">
                            <asp:Button ID="btnSubmit" OnClientClick="return validate();" runat="server" CssClass="button_bg"
                                Text="Submit" OnClick="btnSubmitNew_Click" />
