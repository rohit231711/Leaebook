<%@ Page Title="International Services" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="International_Service.aspx.cs" Inherits="Admin_International_Service" %>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-ForeColor="Black">
                            ...
                            <HeaderTemplate>
                                ...
                                <asp:LinkButton ID="lnkweight" CssClass="no-sort" runat="server" OnClick="lnkweight_Click"  Text="Weight Range"></asp:LinkButton>
                            </HeaderTemplate>
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
            ...
            <tbody>
                ...
                <tr class="light_bg">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                        <asp:TextBox ID="txtfrwe"  onkeypress="return isNumberKey(event,this)" class="input_box user1" runat="server"></asp:TextBox>
