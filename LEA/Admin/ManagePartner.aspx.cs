...
public partial class Admin_ManagePartner : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["add"] == "true")
            {
                ...
                Global.Alert(this, "Partner added successfully.");
            ...
            if (Request.QueryString["EDIT"] == "true")
            {
                ...
                Global.Alert(this, "Partner edit successfully.");
    ...
    {
        Global.Alert(this.Page, "Partner has been deleted.");
        DeleteFlight();
    ...
    protected void gvRegistration_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit1")
        {
            ...
            // Response.Redirect("javascript:void()");
             Response.Redirect("AddPartner.aspx?RegistrationID=" + CommandArgument + "&EDIT=true");
        }
    ...
    private void BindGrid(int pageIndex)
    {
        ...
        dTable = objRegistration.SelectAllRegistrationPartner(pageIndex, pageSize);
