            ...
            <asp:GridView ID="grd_services" runat="server"  AllowPaging="true" PageSize="10" SkinID="skinGrid" GridLines="None"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField ItemStyle-ForeColor="Black">
                            <HeaderStyle CssClass="table-header-repeat line-left" />
                            <HeaderTemplate>
                                 <asp:LinkButton ID="lnkcou" OnClick="lnkcou_Click1" CssClass="no-sort" runat="server"   Text="Country"></asp:LinkButton>
                            </HeaderTemplate>
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
                                <asp:Label ID="lblcou" runat="server" Text='<%# Eval("countryname") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                       ...
                       <asp:TemplateField ItemStyle-ForeColor="Black">
                            <HeaderStyle CssClass="table-header-repeat line-left" />
                            <HeaderTemplate>
                                 <asp:LinkButton ID="lnkcou1" OnClick="lnkcou_Click" CssClass="no-sort" runat="server"   Text="City"></asp:LinkButton>
                            </HeaderTemplate>
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
                ...
                <tr>
                 ...
                 <tr class="light_bg">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                      <asp:DropDownList ID="ddlcou" RepeatColumns="5" RepeatLayout="Table"  runat="server"></asp:DropDownList>
                    </td>
                </tr>
                  ...
                  <tr class="light_bg">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                        <asp:TextBox ID="txtcity"  style="width: 195px;height: 32px;" class="input_box user1" runat="server"></asp:TextBox>
