...
public partial class Admin_ManageCategory : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {                  
            ...
            {
                Global.Alert(this, "Labels added successfully.");
            }
            if (Request.QueryString["edit"] == "true")
            {
                Global.Alert(this, "Labels updated successfully.");
            }
        }
    }
    ...
    protected void lkbDelete_Click(object sender, EventArgs e)
    {
        ...
        DeleteFlight();
        Global.Alert(this, "Labels deleted successfully."); 
        accessrights();
        BindGrid(pageIndex);
    }
    ...
    protected void gvCategory_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit1")
        {
            ...
            Response.Redirect("ManageLable.aspx?name=" + e.CommandArgument.ToString() + "");
        }
    ...
    private void BindGrid(int pageIndex)
    {
        ...
        {
            Key = hndcategory.Value;
        }
        
        
        objCategory.SortColumn = SortColumn;
        objCategory.SortStatus = SortStatus;
        dTable = objCategory.GetLocalizationKeyValue();

        if (Key != "")
        {
            DataView dv = new DataView(dTable);
            dv.RowFilter = "Name like '%" + Key + "%' or English like '%" + Key + "%' or Spanish like '%" + Key + "%'";
            dTable = dv.ToTable();
            hndcategory.Value = "";
        }
    ...
    private void DeleteFlight()
    {
        ...
        BindGrid(pageIndex);
        // Global.Alert(this.Page, "Category has been deleted.");
    }
    #endregion
}