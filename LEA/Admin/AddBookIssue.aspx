<%@ Page Title="eBooks" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" EnableEventValidation="true" CodeFile="AddBookIssue.aspx.cs"
    Inherits="Admin_AddBookIssue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        {
            debugger;
            var tw = document.getElementById("<%=txtWeight.ClientID%>");
            var tdw = document.getElementById("<%=txtDimWeight.ClientID%>");

            if (tw.value != "")
            {
                var fl = parseFloat(tw.value).toFixed(1);
                var fl1 = fl.toString().split(".")[1];
                if (fl1 == '0' || fl1 == '5')
                { }
                else
                {
                    tw.value = "";
                    alert("Paper book weight should be in the ratio of the 0.5 kg.");
                    return false;
                }
            }

            if (tdw.value != "") {
                var fl = parseFloat(tdw.value).toFixed(1);
                var fl1 = fl.toString().split(".")[1];
                if (fl1 == '0' || fl1 == '5')
                { }
                else
                {
                    tdw.value = "";
                    alert("Paper book dimension weight should be in the ratio of the 0.5 kg.");
                    return false;
                }
            }
        ...
        <table align="center" id="id-form" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
                ...
                <tr class="light_bg" id="dis">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                        <asp:TextBox ID="txtDiscount" runat="server" onkeypress="return isNumberKey(event); " CssClass="input_box user1" OnBlur="finalprice(); Discount();" MaxLength="3"></asp:TextBox>
                        <font class="required">*</font>
                    </td>
                </tr>
                    ...
                    <td colspan="3">
                        <table style="width:100%">
                            <tr class="light_bg">
                                ...
                                <td class="popup_listing_border" align="left" valign="middle" width="459">
                                    <asp:TextBox ID="txtWeight" onchange="return check_ratio()" runat="server" CssClass="input_box user1" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                    <font class="required">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Label ID="nt1" class="required" runat="server" Text="Note : Weight should be in the ratio of the 0.5 kg."></asp:Label>
                                </td>
                            </tr>
                            <tr class="light_bg">
                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                                ...
                                <td class="popup_listing_border" align="left" valign="middle" width="459">
                                    <asp:TextBox ID="txtDimWeight" onchange="return check_ratio()" runat="server" CssClass="input_box user1" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                    <font class="required">*</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                     <asp:Label ID="Label1" runat="server" class="required" Text="Note : Weight should be in the ratio of the 0.5 kg."></asp:Label>
                                </td>
                            </tr>
                            <tr class="light_bg">
                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                ...
                <%--<tr class="white_bg">
                    ...
                    <td align="left">
                        <asp:Button ID="btnAddCharge" runat="server" Text="Add Country" CssClass="button_bg" />
                    </td>
                </tr>--%>
                <tr class="light_bg" style="display: none;">
                    <%--<td align="right">&nbsp;
                    ...
                    <td align="left" colspan="3">
                        <table style="width: 50%; margin-left: 15%;">
                            ...
                            <tr>
                                <td>
                                    <asp:DropDownList ID="ddlCountry" runat="server" CssClass="select_box text-input"></asp:DropDownList>
                                </td>
                                <td>
                                    <asp:TextBox ID="txtCharge" runat="server" Text="0.0" CssClass="input_box user1" onkeypress="return isNumberKey(event)"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                ...
                <%-- <tr class="light_bg pnl3">
                    <td align="right">
                        <strong>End page No.</strong>
                    </td>
                    <td align="left" height="37">
                        &nbsp;
                    </td>
                    <td align="left">
                        <asp:TextBox ID="txtPDFEndPage" runat="server"></asp:TextBox>
                    </td>
                </tr>--%>
                ...
                <tr class="white_bg">
                    ...
                    <td align="left">
                        ...
                        <asp:Button ID="btnCancel" Text="Cancel" runat="server" CssClass="button_bg" PostBackUrl="~/Admin/ManageBook.aspx"
