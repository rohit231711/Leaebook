<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" CodeFile="national_shipping.aspx.cs" Inherits="Admin_national_shipping" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
          ...
          function validateCheckBoxes() {
            ...
            document.getElementById('succ').innerHTML = "Please select at lease one city.";
            return false;
        }
        function conf() {
    ...
    <div id="product-table">
        ...
        <div id="form_user_managementview">
            <asp:GridView ID="grd_services" runat="server"  AllowPaging="true" PageSize="10" SkinID="skinGrid" GridLines="None"
                    AutoGenerateColumns="false" Width="100%" OnRowDataBound="grd_services_RowDataBound" OnPageIndexChanging="grd_services_PageIndexChanging"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ItemStyle-ForeColor="Black">
                         ...
                         <asp:TemplateField ItemStyle-ForeColor="Black">
                            <HeaderStyle CssClass="table-header-repeat line-left" />
                            <HeaderTemplate>
                                 <asp:LinkButton ID="lnkcity" OnClick="lnkreg_Click" CssClass="no-sort" runat="server"   Text="City"></asp:LinkButton>
                            </HeaderTemplate>
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
                         ...
                         <asp:TemplateField ItemStyle-ForeColor="Black">
                            <HeaderStyle CssClass="table-header-repeat line-left" />
                            <HeaderTemplate>
                                <span style="padding-left: 10px; font-size: 12px;">Shipping Cost</span>
                            </HeaderTemplate>
                            <ItemStyle Font-Size="14px" />
                            <ItemTemplate>
                                <asp:Label ID="lblscost" runat="server" Text='<%# Eval("shipping_cost") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <tr>
                  ...
                  <tr class="light_bg">
                    ...
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                        <asp:TextBox ID="txtcity"  style="width: 195px;height: 32px;" class="input_box user1" Enabled="false" runat="server"></asp:TextBox>
                ...
                <tr class="light_bg">
                    <td class="popup_listing_border" align="right" valign="middle" width="130">
                      <%--  <strong>Country :</strong>--%>
                         <strong><asp:Label ID="lblh" runat="server" Text="Shipping Cost :" ></asp:Label></strong>
                    </td>
                    <td class="popup_listing_border" align="left" height="37" width="11">&nbsp;
                    </td>
                    <td class="popup_listing_border" align="left" valign="middle" width="459">
                      <asp:TextBox ID="txtship"  runat="server" class="input_box user1" style="width: 195px;height: 32px;"></asp:TextBox>
                        <font class="required">*</font>
                    </td>
                </tr>
