<%@ Page Title="Manage Category" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ManageCategory.aspx.cs" Theme="Default" Inherits="Admin_ManageCategory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function backcode() {
            ...
            if (document.getElementById('<%=txtcategory.ClientID %>').value == "" && document.getElementById('<%=txtcategory1.ClientID %>').value == "") {
                ...
                //document.getelementbyid('succ').innerhtml = "please insert category name.";
            }
            else {
                //alert("hi");
                document.getElementById('<%=hndcategory.ClientID %>').value = document.getElementById('<%=txtcategory.ClientID %>').value;
                document.getElementById('<%=hndcategory1.ClientID %>').value = document.getElementById('<%=txtcategory1.ClientID %>').value;
    ...
    <asp:HiddenField ID="hndcategory1" runat="server" />
                            ...
                            <div id="actions-box">
                                ...
                                <div id="actions-box-slider" style="display: none;">
                                    <a id="callConfirm" onclick="conf(); return false;" class="action-delete" style="cursor: pointer">
                                        Delete</a>
                                    <%--<a id="testCheck2" onclick="statusactive()" class="action-delete" style="cursor: pointer">
            ...
            <asp:GridView ID="gvCategory" runat="server" SkinID="skinGrid" GridLines="None" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        ...
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbCategory" runat="server" CommandArgument="CategoryName" CommandName="Sort"
                                Text="Category (English)" CssClass="no-sort"></asp:LinkButton>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black">
                        <HeaderStyle CssClass="table-header-repeat line-left" />
                        <HeaderTemplate>
                            <asp:LinkButton ID="lkbCategory1" runat="server" CommandArgument="CategoryName1" CommandName="Sort"
                                Text="Category (Spanish)" CssClass="no-sort"></asp:LinkButton>
                            <asp:Image ID="imgCategory1" Visible="false" runat="server" AlternateText=" " />
                        </HeaderTemplate>
                        <ItemStyle Font-Size="14px" />
                        <ItemTemplate>
                            <asp:Label ID="lblCategoryName1" runat="server" Text='<%# Eval("CategoryName1") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderStyle-Width="70px" ItemStyle-Width="70px">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hfID" runat="server" Value='<%#Eval("CategoryID")%>' />
                            <asp:LinkButton ID="lkbDelete" runat="server" CssClass="icon-102" CommandName="Delete1"
                                CommandArgument='<%#Eval("CategoryID")%>' OnClientClick="return confirm('Are you sure you want to delete?');"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="light_bg">
                                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                                                    <strong>Category (English)</strong>
                                                </td>
                                            ...
                                            <tr class="light_bg">
                                                <td class="popup_listing_border" align="right" valign="middle" width="130">
                                                    <strong>Category (Spanish)</strong>
                                                </td>
                                                <td class="popup_listing_border" align="left" height="37" width="11">
                                                    &nbsp;
                                                </td>
