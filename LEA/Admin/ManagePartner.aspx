<%@ Page Title="Manage Partner" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="ManagePartner.aspx.cs" Inherits="Admin_ManagePartner" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <span id="spanSelectedMenu" style="display: none">apartner</span>
    ...
    <script type="text/javascript">
        function validateCheckBoxes() {
            ...
            document.getElementById('succ').innerHTML = "Please select at lease one partner.";
            return false;
        }
        function conf() {
                    ...
                    <tr>
                        ...
                        <td width="16%" valign="bottom" align="right">
                            <div style="padding-bottom: 1px; padding-right: 5px; text-align: right; float: right;">
                                ...
                                <asp:Button ID="btnAdd" runat="server" CssClass="button_bg" PostBackUrl="~/Admin/AddPartner.aspx" Text="Add New" />
                            </div>
                        </td>
                    </tr>
                </tbody>
        ...
        <div id="form_user_managementview">
            <asp:GridView ID="gvRegistration" runat="server" SkinID="skinGrid" GridLines="None"
                ...
                <Columns>
                    ...
                    <asp:TemplateField ItemStyle-ForeColor="Black" HeaderText=" Is Active">
