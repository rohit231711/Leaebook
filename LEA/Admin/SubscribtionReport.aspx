<%@ Page Title="Order Report" Language="C#" MasterPageFile="~/Admin/AdminMaster.master"
    AutoEventWireup="true" CodeFile="SubscribtionReport.aspx.cs" Inherits="SubscribtionReport" %>
                        ...
                        <asp:GridView ID="grdSubscriptions" OnPageIndexChanging="grdSubscriptions_OnPageIndexChanging"
                            ...
                            <Columns>
                                <asp:TemplateField ItemStyle-ForeColor="Black">
                                    ...
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" Width="70" Height="100" AlternateText='<%# "/Book/"+Eval("CategoryID")+"/"+Eval("ImagePath") %>' src='<%#PicturePath("Book/"+Eval("CategoryID")+"/"+Eval("ImagePath").ToString().Replace("_1.jpg","_1_1.jpg")) %>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField ItemStyle-ForeColor="Black">
                                    <HeaderStyle CssClass="table-header-repeat line-left" />
