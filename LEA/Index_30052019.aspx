<%@ Page Title="Home" Language="C#" MasterPageFile="~/LEA_Master.master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Index" %>
            ...
            <div class="rightbarmid" style="padding-bottom: 15px;">
                <div class="mln-panel">
                    ...
                    <div class="cat-list-top-bar">
                        <a href='AllBooks.aspx?l=<%= System.Threading.Thread.CurrentThread.CurrentCulture.Name.ToString() %>' class='titnewre1'><%= Localization.ResourceManager.GetString("viewallbook", System.Threading.Thread.CurrentThread.CurrentCulture.Name).ToString() %></a>
                        <div class="dropdown">
