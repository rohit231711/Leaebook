        ...
        <div class="loginbox1">
            ...
            <%--<div class="frm-txt">
                <label class="birthtxt">
                    ...
                    <span class="star">*</span></label>
                <asp:TextBox ID="txt_birthdate" runat="server" CssClass="nametxt" ReadOnly="true" Text=""></asp:TextBox>
                <cc1:CalendarExtender ID="CalendarExtender1" runat="server" Format="MMM/dd/yyyy" TargetControlID="txt_birthdate">
