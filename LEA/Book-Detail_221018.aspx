        ...
        <div class="cartbox">
                ...
                <div class="sharebox">
                    ...
                    <div class="sh-icon">
                        ...
                        <a class="twitter-share-button" href="https://twitter.com/share" data-related="twitterdev"
                            ...
                            <img src="<%= Config.WebSiteMain %>images/twit-blk.png" alt="" />
                            ...
                            <img src="<%= Config.WebSiteMain %>images/pin-blk.png" alt="" />
                        </a>
            ...
            <div class="cart-rt">
                ...
                <div class="btxt">
                    <div class="au-name">
                        Book
                        <asp:DropDownList ID="ddlBookType" runat="server" onchange="return ChnageBookDiv(this);" AppendDataBoundItems="true"></asp:DropDownList>
                    </div>
                    <div class="au-name">
                ...
                <div class="writepnl">
                    <div class="starbox" style="width: 100%; margin-bottom: 10px">
                        ...
                        <span class="ratetxt2">
                            <asp:Label ID="lbl_Totalrating" runat="server" Text=""></asp:Label></span>
                    </div>
                    <span style="font-family: 'amaranthregular'; padding-left: 11%; margin-top: 10px;">Rating :
                        <asp:Label ID="lblRatingoutofall" runat="server" Text=""></asp:Label></span>
                    <asp:HiddenField ID="Check_User_Session" runat="server" />
            ...
            <div style="width: 100%; float: left; font-size: 24px; font-weight: bold; border-bottom: 1px solid #c2c2c2; font-family: 'amaranthregular';">
                ...
                <div>
                    <asp:LinkButton ID="lnk_writereview" runat="server" OnClientClick="return WriteReview();" Visible="false">
                        <div class="rview">
                            <img src="<%= Config.WebSiteMain %>images/review.png" alt="" class="rimg" />
                            <span class="rtxt">
            ...
            <div id="ltrReviewList" runat="server" style="font-family: 'amaranthregular'; float: left; width: 100%;max-height:300px;overflow:hidden;">
            </div>
            <div style="width:100%;float:left;padding-top:20px" id="divReadmore" runat="server"><a id="reviviewreadmore" href="Javascript:void(0)" onclick="return readmore(this);">Read More</a></div>
            <div class="rviewbox" id="writereviewbox" hidden>
                <div class="rviewtxt">
