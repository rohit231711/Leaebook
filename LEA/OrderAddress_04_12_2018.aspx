            ...
            <div class="orderacc-rt" style="margin-top: 30px;">
                                ...
                                <div class="row-new">
                                    <div class="first1" style="width: 516px;">
                                        <div class="booktxt">
                                            ...
                                            <asp:Label runat="server" ID="Label1" class="bname" Visible="false">Name</asp:Label>
                                            <asp:TextBox ID="txtName" runat="server" Text='<%#Eval("Name")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox>
                                            <asp:Label runat="server" ID="lb_street" class="bname" Visible="false">Street Address</asp:Label>
                                            ...
                                            <asp:Label runat="server" ID="lb_Landmark" class="bname" Visible="false">Land Mark</asp:Label>
                                            ...
                                            <asp:Label runat="server" ID="lblState" class="aname"><%#Eval("State")%></asp:Label>
                                               ...
                                               <asp:Label runat="server" ID="lb_region" class="bname" Visible="false">Region</asp:Label>
                                            ...
                                            <asp:DropDownList ID="ddlregrpt" AutoPostBack="true" OnSelectedIndexChanged="ddlregion_SelectedIndexChanged" runat="server" Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>
                                             <asp:Label runat="server" ID="lb_country" class="bname" Visible="false">Country</asp:Label>
                                            ...
                                            <asp:DropDownList ID="ddlCountryRpt" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCountryRpt_SelectedIndexChanged" Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>
                                              <asp:Label runat="server" ID="lb_State" class="bname" Visible="false">State</asp:Label>
                                            ...
                                            <asp:Label runat="server" ID="lb_City" class="bname" Visible="false">City</asp:Label>
                                          ...
                                          <div style="float: right;">  <asp:LinkButton ID="lnk_vis" runat="server" Text="Other" OnClick="lnk_vis_Click" style="display:none;"></asp:LinkButton></div>
                                             <asp:Label runat="server" ID="lb_pincode" class="bname" Visible="false">pincode</asp:Label>
                                            ...
                                            <span class="bname">
                                                <asp:Label runat="server" ID="lb_phone" class="bname" Visible="false">Phone Number</asp:Label>
                ...
                <div class="check-box">
                    <div>
                        ...
                        </asp:LinkButton><a id="aClick" class="movebtn" onclick="toggle_visibility('dialog');" style="cursor: pointer;">Add <Localized:LocalizedLiteral ID="LocalizedLiteral6" runat="server" Key="deliveryAdd" Colon="false" />
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="loginbox1">
                    ...
                    <div class="frm-txt">
                        ...
                        <label class="name1" style="width: 100%;">
                            ...
                            <span class="star">*</span></label> <asp:DropDownList ID="ddlregion" OnSelectedIndexChanged="ddlregion_SelectedIndexChanged1" AutoPostBack="true" runat="server" CssClass="nametxt" AppendDataBoundItems="true"></asp:DropDownList>
                    ...
                    <div class="frm-txt">
                        <label class="name1" style="width: 100%;">
                            ...
                            <span class="star">*</span> </label><asp:TextBox ID="txtstate" runat="server" class="nametxt" Text=""></asp:TextBox></div><div class="frm-txt">
                        <label class="name1">
                        ...
                        <asp:TextBox ID="txtcity" runat="server" Visible="false" class="nametxt" Text=""></asp:TextBox><div style="float: right; display: none">
                            <asp:LinkButton ID="lnkother" runat="server" Text="Other" OnClick="lnkother_Click" style="display:none;"></asp:LinkButton></div></div><div class="frm-txt">
                        <label class="name1">
                        ...
                        <label class="name1">
                            ...
                            <span class="star">*</span></label> <asp:TextBox ID="txtPhone" runat="server" class="nametxt" Text=""></asp:TextBox></div><br />
                    <br />
                    <div class="btns">
                        <a onclick="toggle_visibility('dialog');" style="cursor: pointer;" class="back">
                            <img src="images/backarw.png" alt="" class="bkarw" /> Hide <%--<Localized:LocalizedLiteral ID="lblback" runat="server" Key="back" Colon="false" />--%></a>
