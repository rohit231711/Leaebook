...
public partial class Partner_ManageBookPurchase : System.Web.UI.Page
{
    ...
    {
        objmenu.UserID = Convert.ToInt32(Session["PartnerRegistrationID"]);
    ...
    private void BindGrid(int pageIndex)
    {
        ...
        DataSet ds_table = objbook.get_BookPurchasePartner();
