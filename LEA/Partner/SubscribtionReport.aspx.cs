...
public partial class Partner_SubscribtionReport : System.Web.UI.Page
{
    ...
    public void BindGrid(int CustomerID)
    {
        ...
        var PartnerID = Convert.ToInt32(Session["PartnerRegistrationID"].ToString());
        dt = ObjBookOrderBal.GetSubscriptionsForPartner(PartnerID);
        if (dt.Rows.Count > 0)
        {
