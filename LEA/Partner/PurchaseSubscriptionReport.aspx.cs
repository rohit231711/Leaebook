...
public partial class Partner_ManageBook : System.Web.UI.Page
{
    ...
    protected void grdCustomer_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit1")
        {
            ...
            Response.Redirect("AddBookIssue.aspx?BookID=" + Security.AES256Encrypt(CommandArgument.ToString()) + "&EDIT=true");
        }
    ...
    private void BindGrid(int pageIndex)
    {
        ...
        DataSet ds = objRegister.GetSubscriberAndPurchaseUsersPartner(Session["PartnerRegistrationID"].ToString(), pageIndex, pageSize, Convert.ToInt32(hndDdlID.Value));
