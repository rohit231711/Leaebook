...
public partial class Partner_MyAccount : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Session["PartnerRegistrationID"] != null)
            {
                ...
                objUser.RegistrationID = Convert.ToInt32(Session["PartnerRegistrationID"]);
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        ...
        objUser.UserType = 1;
        Session["PartnerUsername"] = txtUsername.Text.Trim();
