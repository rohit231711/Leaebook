<%@ Page Title="My Account" Language="C#" MasterPageFile="~/Partner/PartnerMaster.master" AutoEventWireup="true" CodeFile="MyAccount.aspx.cs" Inherits="Partner_MyAccount" %>
            ...
            <tr class="light_bg">
                ...
                <tr class="white_bg">
                    ...
                    <td align="left">
                        ...
                        <asp:Button ID="btnCancel" Text="Cancel" runat="server" CssClass="button_bg" PostBackUrl="~/Partner/dashboard.aspx"
