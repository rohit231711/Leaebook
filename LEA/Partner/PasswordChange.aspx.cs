...
public partial class Partner_PasswordChange : System.Web.UI.Page
{
    ...
    public int RegistrationID
    {
        ...
        {
            int id = 0;
            if (Session["PartnerRegistrationID"] != null || Session["PartnerRegistrationID"] != "")
            {
                id = Convert.ToInt32(Session["PartnerRegistrationID"]);
                return id;
            }
            return id;
        }
