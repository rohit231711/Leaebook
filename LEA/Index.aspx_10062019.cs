...
public partial class Index : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //var x = Request.UserHostAddress;
        //GeoService.GeoIP output = service.GetGeoIP(Request.UserHostAddress);
        //lblCountry.Text = "Country: " + output.CountryName;
        //lblCountry.ForeColor = setColorLabel(output.CountryName);
        //lblCountry.Visible = lblCountry.ForeColor == Color.Red;

        //ScriptManager.RegisterStartupScript(this, GetType(), "for", String.Format("console.log('{0} {1}');", "Country: " + output.CountryName," IpAddress: " + x), true);
        //ScriptManager.RegisterStartupScript(this, GetType(), "for", String.Format("console.log('{0} {1}');", "MAC1: " + GetMACAddress1(), " IpAddress: " + x), true);
        ...
        else
        {
            ...
            if (Session["UserID"] != null && Session["UserID"].ToString() != "")
            {
                ...
                if (Request.QueryString["id"] != null && Request.QueryString["id"].ToString() != "")
                {
                    try
                    {
                        Obj_Book.BookID = objPurchase.BookID = Convert.ToInt16(Convert.ToInt32(S.Decrypt(HttpUtility.UrlDecode(Request.QueryString["id"]))).ToString());
                    }
                    catch
                    {
...

    {
        ...
        if (Request.QueryString["l"] != null && Request.QueryString["l"].ToString() != "")
        {
            ...
            {
                Obj_Book.LanguageID = Language = 2;
                // string Title = "Compra libros baratos en línea, los mejoes y más baratos libros electrónicos en El Salvador, LEA";
                // string Description = "Adquiere libros en línea, a precios bajos en El Salvador en la Librería Virtual LEA. Encuentra una colección de libros electrónicos de diferentes categorías como erotismo, Latinoamericanos, Filosofia y obras salvadoreñas de ecritores reconocidos escritores profesionales.";
            ...
            else if (Request.QueryString["l"].ToString() == "en-US")
            {
                ...
                // string Description = "Buy eBook online at cheap prices in El Salvador at LEA Virtual Bookshop. Find electronic book collection of different categories like eroticism, Latin America, philosophy and Salvadorans from the popular and professional writer.";
                string Title = "Buy Cheap eBooks Online, Best Cheap eBook El Salvador- LEA";
