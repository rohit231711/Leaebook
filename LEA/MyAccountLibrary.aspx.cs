...
public partial class MyAccountLibrary : System.Web.UI.Page
{
    ...
    private static void GenerateThumbnails(string sourcePath, string targetPath)
    {
    ...
    //                   "<a href='AllBooks.aspx?l=es-ES' class='titnewre1'>Ver todos eBook</a>" +
    //               "</div>";
    ...
    //           "<a href='AllBooks.aspx?l=en-US' class='titnewre1'>View All eBook</a>" +
    //       "</div>";
    ...
    //            else
    //            {
    //                str = str + "<div class='bookimg'>" + "<a href='Book-Detail.aspx?" + "&title=" + HttpUtility.UrlEncode(Convert.ToString(dr["Title"])) + "&l=" + System.Threading.Thread.CurrentThread.CurrentCulture.Name + "&mylib=1'> <img src='" + img + "' alt='' height='306' width='223' /></a>";
    ...
    //            }
    //            str = str + "<div class='namkl2'><a href='Book-Detail.aspx?" + "&title=" + HttpUtility.UrlEncode(Convert.ToString(dr["Title"])) + "&l=" + System.Threading.Thread.CurrentThread.CurrentCulture.Name + "&mylib=1' style='color:#616161'>" + dr["BookTitle1"] + "</a></div>" + "<div class='author'>" + dr["Autoher"] + "</div>";
    //            if (Convert.ToBoolean(dr["IsFree"]) == true)
    //            {
    ...
    public void BindData()
    {
        ...
        string a1;
        if (Request.QueryString["l"].ToString() == "es-ES")
            a1 = "<div class='panel'>" + "<div class='titnewre'>Mi biblioteca</div></div>";
        else
            a1 = "<div class='panel'>" + "<div class='titnewre'>My Library</div></div>";
        string str = "";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                if (!hashtable.ContainsKey(dr["BookID"]))
                {
                    ...
                    {
                        var amount = dr["Amount"].ToString() == "" || dr["Amount"].ToString() == null ? "0" : dr["Amount"].ToString();
                        str = str + "<div class='namkl'>$" + amount + "</div>";
                    }
