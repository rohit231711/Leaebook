...
public partial class Biography : System.Web.UI.Page
{
    ...
    public void BindData()
    {
        ...
        buynowtitle = Localization.ResourceManager.GetString("addtocart");
        ...
        if (Request.QueryString["catid"] != null && Request.QueryString["catid"].ToString() != "")
        {
            ...
            if (DT != null && DT.Rows.Count > 0)
            {
                ...
                lblcat.Text = DT.Rows[0]["Title"].ToString();
                lbldesc.Text = DT.Rows[0]["Description"].ToString();
                if(string.IsNullOrEmpty(lblcat.Text)  & (string.IsNullOrEmpty(lbldesc.Text)))
                {
                    lblcat.Text = DT.Rows[0]["CategoryName"].ToString();
                ...
                {
                    this.Page.Title = lblcat.Text;
                    this.Page.MetaDescription = lbldesc.Text;
                }
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (Convert.ToBoolean(dr["IsFree"]) == true)
                {
                    str = str + "<a href='Index.aspx?fbid=" + HttpUtility.UrlEncode(S.Encrypt(Convert.ToString(dr["BookID"]))) + "&l=" + System.Threading.Thread.CurrentThread.CurrentCulture.Name + "' class='boxbut'>" + buynowtitle.ToString() + "</a>" +
                "</div>";
                }
                else
                {
        ...
        //Response.Redirect(GetRouteUrl("Categories","Biography.aspx"));
