...
<!-- -->
Popup.preview = function(divObject, referenceObject, position, options) {
	//document.getElementById('hid_productid').value = referenceObject;
	Popup.show(divObject, referenceObject, position, options, true);
};

Popup.view = function(divObject, referenceObject, position, options) {
	//document.getElementById('hid_productid').value = referenceObject;
	Popup.show(divObject, referenceObject, position, options, true);
};
Popup.showsearch = function(divObject, referenceObject, position, options) {
	//document.getElementById('hid_productid').value = referenceObject;
	Popup.show(divObject, referenceObject, position, options, true);
};
Popup.showrejectwithdraw = function(divObject, referenceObject, position, options) {
	//document.getElementById('hid_productid').value = referenceObject;
	Popup.show(divObject, referenceObject, position, options, true);
};
<!-- -->
////// FUNCTION TO DELETE INBOX MESSAGE
Popup.showModaldelinbx = function(divObject, referenceObject, position, options) {
	
	//<><><><><><><><>This is extra code added for post-job page to add queston and delete question<><><><><><><><><>
	document.getElementById('hid_mid').value = referenceObject;
	Popup.show(divObject, referenceObject, position, options, true);
};
<!-- -->
