...
<script RunAt="server">
    ...
    {
        //routes.MapPageRoute("HomePage", "123.aspx", "~/Index.aspx?l=es-ES");
        //routes.MapPageRoute("Categories", "Biography.aspx", "~/Biography.aspx");
        //routes.MapPageRoute("Categories", "Biography", "~/Biography.aspx");
        //routes.MapPageRoute(
        //    name: "Categories",
        //    url: "{controller}/{action}/{id}",
        //    defaults: new { controller = "Biography.aspx", action = "Index", id = UrlParameter.Optional }
        //); 
    }
