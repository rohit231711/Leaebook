...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="wrap">
        <div class="loginbox abc-loginbox">
            <div class="logintxt">
                <h1>
            ...
            <div class="loginbg">
                ...
                <!--rt end-->
                <div <%--class="btnbox-rt"--%> class="cust-rt abc-login-button-row" style="margin-top: 0px">

                    <%--<a href="#" class="accbtn">--%>
                    <asp:Button ID="btn_login" runat="server" class="accbtn" OnClientClick="return validation();" Style="margin-top: 5px;cursor:pointer" Text="Login" OnClick="btn_login_Click"></asp:Button><%--</a>--%>
                    <span class="forgottxt">
                        <a href="Forgot-Password.aspx?l=<%=System.Threading.Thread.CurrentThread.CurrentCulture.Name %>">
                            <Localized:LocalizedLiteral ID="lblforgotpassword" runat="server" Key="forgotyourpassword1" Colon="false" />
                        </a>
                    </span>
                </div>
            </div>
