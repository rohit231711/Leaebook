...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="breadcrumb">
        <div class="wrap">
            <ul>
                <li><a href="Index.aspx?l=<%=System.Threading.Thread.CurrentThread.CurrentCulture.Name.ToString() %>">
                                ...
                                <div class="first1">
                                    <div class="booktxt" style="width: auto;">
                                        ...
                                        <asp:TextBox ID="txtcity12" runat="server" Text='<%#Eval("City")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;">
                                            ...
                                            </asp:LinkButton></div><asp:Label runat="server" ID="lblCityCode" class="aname"><%# Eval("City").ToString().Replace("- 00000","") + (Convert.ToString(Eval("Pincode")) != "00000" ? (" - " + Eval("Pincode")) : "") %>
                                        ...
                                        </asp:Label></span></div><input type="hidden" value="0" id="hdnDeleteValue" /></div><div class="delbtn2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div>
                                            ...
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral18" runat="server" Key="DHL_shipping_Amount" Colon="false" />&nbsp; <b><asp:Label ID="lbldhl1" runat="server">
                                                </asp:Label><br /><asp:RadioButton ID="chknational" runat="server" onchange="val(this);" GroupName="Shiping" />
                                                <Localized:LocalizedLiteral ID="LocalizedLiteral17" runat="server" Key="national_shipping_amount" Colon="false" />&nbsp; <b><asp:Label ID="lblShipAmount" runat="server" CssClass="Shipping">
            ...
            <div>
                ...
                <div class="loginbox1">
                    ...
                    <div class="btns" runat="server" id="btn">
                        ...
                        </asp:LinkButton><asp:Label ID="lbl_loader" runat="server" Text="Please Wait..." Visible="false"></asp:Label></div></div></div></div></div></asp:Content>