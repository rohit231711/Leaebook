                                            ...
                                            <div class="booktxt">
                                                ...
                                                <span class="bname">
                                                    ...
                                                    <asp:Label ID="lblOrderNo" runat="server" Text='<%#Eval("OrderNo")%>'></asp:Label></span><span class="bname"><Localized:LocalizedLiteral ID="LocalizedLiteral7" runat="server" Key="lbl_book" Colon="false" />
                                                        <asp:label id="lblBookType" runat="server" Text='<%# getKeyFromBook(Convert.ToBoolean(Eval("IspaperBook")),Convert.ToBoolean(Eval("IseBook"))) %>' Style="display:none"></asp:label>
                                                ...
                                                <span class="bname" runat="server" visible='<%# Eval("IspaperBook") %>'>Quantity :
                                                    ...
                                                    <asp:TextBox ID="txtQuanitity" runat="server" Text='<%# getQuantity(Eval("BookID").ToString(),Eval("Qauntity").ToString()) %>' onkeypress="return isNumberKey(event)" min='<%# getMinQuantity(Eval("BookID").ToString()) %>' max='<%# getMaxQuantity(Eval("BookID").ToString()) %>' ToolTip='<%# getMaxQuantity(Eval("BookID").ToString()) %>' type="number" Visible='<%# Eval("IspaperBook") %>'
                                                        Style="width: 15%; padding: 5px 0px 5px 5px;" onkeydown="return onkeyupp();" ReadOnly="true" AutoPostBack="true" OnTextChanged="txtQuanitity_TextChanged" Enabled='<%# getQuantity(Eval("BookID").ToString(),Eval("Qauntity").ToString()) >= 1?true:false%>'></asp:TextBox>
                                                    <asp:HiddenField ID="hfQuantity" runat="server" Value='<%# Eval("Qauntity") %>' />
        ...
        <div class="loginbox1" style="margin-top: 0px; margin-bottom: 20px;">
                            ...
                            <div class="row-new">
                                <div class="first1">
                                    <div class="booktxt" style="width: auto;">
                                        ...
                                        <asp:label ID="locallizationname" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="lblfirstname" runat="server" Key="shipName" Colon="false" /></asp:label>
                                        ...
                                        <asp:label ID="locallizationaddress1" runat="server" class="name1" Style="width:100%" Visible="false"><Localized:LocalizedLiteral ID="LocalizedLiteral2" runat="server" Key="shipAdd1" Colon="false" />
                                        (<Localized:LocalizedLiteral ID="LocalizedLiteral20" runat="server" Key="shipAdd1_Detail" Colon="false" />)</asp:label>
                                        ...
                                        <asp:Label ID="locallizationaddress2" runat="server" class="name1" Style="width:100%" Visible="false">
                                        ...
                                        <asp:Label ID="locallizationregion" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="LocalizedLiteral16" runat="server" Key="Region" Colon="false" /></asp:Label>
                                        <asp:DropDownList ID="ddlregrpt" OnSelectedIndexChanged="ddlregrpt_SelectedIndexChanged" AutoPostBack="true" runat="server" Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>
                                        
                                        <asp:Label ID="locallizationcountry" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="LocalizedLiteral22" runat="server" Key="country" Colon="false" /></asp:Label>
                                        <asp:DropDownList ID="ddlCountryRpt" AutoPostBack="true" OnSelectedIndexChanged="ddlCountryRpt_SelectedIndexChanged" runat="server" Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>

                                        <asp:Label ID="locallizationstate" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="LocalizedLiteral28" runat="server" Key="state" Colon="false" /></asp:Label>
                                        <asp:TextBox ID="txtState" runat="server" Text='<%#Eval("State")%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox>

                                        <asp:Label ID="locallizationcity" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="LocalizedLiteral8" runat="server" Key="city" Colon="false" /></asp:Label>
                                        <asp:DropDownList ID="txtCity" runat="server" Visible="false" AutoPostBack="true" OnSelectedIndexChanged="txtCity_SelectedIndexChanged" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:DropDownList>
                                        ...
                                        <asp:Label runat="server" ID="lblCityCode" class="aname"><%# Eval("City").ToString().Replace("- 00000","") + (Convert.ToString(Eval("Pincode")) != "00000" ? (" - " + Eval("Pincode")) : "") %></asp:Label>

                                        <asp:Label ID="locallizationpincode" runat="server" Visible="false" class="name1" Style="width:100%">
                                            <Localized:LocalizedLiteral ID="LocalizedLiteral11" runat="server" Key="pincode" Colon="false" /></asp:Label>
                                        ...
                                        <span class="bname">
                                            ...
                                            <asp:Label ID="locallizationPhone" runat="server" Visible="false" class="name1" Style="width:100%"><Localized:LocalizedLiteral ID="LocalizedLiteral12" runat="server" Key="Phone" Colon="false" /></asp:Label>
                                            <asp:TextBox runat="server" ID="txtPhoneNumber" Text='<%#Convert.ToString(Eval("PhoneNumber"))%>' Visible="false" CssClass="nametxt" Style="margin-bottom: 5px;"></asp:TextBox>
                                        </span>
                                        <span class="bname" style="display:none;">
                                            <asp:Label runat="server" ID="lblShipping" CssClass="shippingLabel"></asp:Label>
                                        </span>
                                    </div>
                                    <input type="hidden" value="0" id="hdnDeleteValue" />
                                </div>
                                ...
                                <div class="ptxt">
                                    ...
                                    <asp:CheckBox ID="chkDeliver" AutoPostBack="true" OnCheckedChanged="chkDeliver_CheckedChanged" runat="server" />
            ...
            <asp:UpdatePanel ID="upAmount" runat="server">
                <ContentTemplate>
                    ...
                    <h2><Localized:LocalizedLiteral ID="LocalizedLiteral19" runat="server" Key="yourorder" Colon="false" /></h2>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Literal ID="lblProductTotal" runat="server"></asp:Literal>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <b><asp:Literal ID="lblSubtotalAmount" runat="server"></asp:Literal></b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <div>
                                    ...
                                    <b><asp:Label ID="lbldhl1" runat="server"></asp:Label></b>
                                    <br />
                                    ...
                                    <b><asp:Label ID="lblShipAmount" runat="server"></asp:Label></b>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblitems" runat="server" Style="display: none"></asp:Label><%--&nbsp;&nbsp;&nbsp;--%>
                                <b>$<asp:Label ID="lblAmount" runat="server" Colon="false" /></b>
